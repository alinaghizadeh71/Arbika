...
public class APISendingpage2 {
    ...
    JSONObject obj;
    public APISendingpage2(Context context, String url) {
   ...
   //    url="http://api.arbika.ir/v1/categories";
        ...
        JsonObjectRequest request= new JsonObjectRequest(Request.Method.POST,url, requestJsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                   ...
                   // boolean meta= response.getBoolean("meta");

                   /* if(id.equals("") || id.isEmpty())
                    {*/
                     arrayStatus = response.getJSONArray("result");
                     obj = response.getJSONObject("meta");
                   // }


                    onSignupComplate.onSignUp(success,arrayStatus,obj);
    ...
    public interface OnSignupComplate{
        void onSignUp(boolean success, JSONArray array_result,JSONObject obj);
    }
}